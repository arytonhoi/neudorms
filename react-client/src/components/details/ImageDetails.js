          ...
          <div class="carousel-inner">
            {this.props.building.pictures && this.props.building.pictures.map((picture, index, pictures) => (
              <div className={index === 0 ? "carousel-item active" : "carousel-item"} key={index}>
                <img src={picture.url} class="col-12 col-md-4 p-0" alt="..." />
                <img src={pictures[(index + 1) % pictures.length].url} class="d-none col-md-4 p-0" alt="..." />
                <img src={pictures[(index + 2) % pictures.length].url} class="d-none col-md-4 p-0" alt="..." />
              </div>
            ))}
          </div>
          <a
